...
import { ConstructionService } from './construction/entities/construction-service.entity';
import { ConstructionCategory } from './construction/entities/construction-category.entity';
  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        entities: [ConstructionService, ConstructionCategory],
