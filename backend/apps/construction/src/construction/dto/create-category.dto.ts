...
export class CreateCategoryDto {
  @ApiProperty({ description: 'Category name', example: 'Residential Construction' })
  @IsString()
  @IsNotEmpty()
  @Length(1, 255)
  name: string;

  @ApiPropertyOptional({ description: 'Category description', example: 'Residential construction services' })
  @IsString()
  @IsOptional()
  @Length(1, 1000)
  description?: string;
