...
export class CreateServiceDto {
  ...
  @ApiProperty({ description: 'Category name (will be created if not exists)', example: 'Web Development' })
  @IsString()
  @IsNotEmpty()
  @Length(1, 255)
  category: string;

  @ApiProperty({ description: 'Service description', example: 'Professional web development services' })
  @IsString()
  @IsNotEmpty()
  @Length(1, 5000)
  description: string;
