...
import { BUSINESS_LOG_ENTRIES } from "../data/business-demo-data"

export default function BusinessLogLayout() {
  const { t } = useLocale()
  const { demoOrEmpty } = useIsDemoAccount()
  const entries = demoOrEmpty(BUSINESS_LOG_ENTRIES, [] as typeof BUSINESS_LOG_ENTRIES)
  const p = t.businessPages.businessLog
