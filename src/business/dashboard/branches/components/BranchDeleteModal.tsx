...
export const BranchDeleteModal: React.FC<BranchDeleteModalProps> = ({ isOpen, onClose, onConfirm, loading }) => {
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Delete Branch" size="sm">
            <div className="flex flex-col items-center gap-6 py-6">
                <AlertCircle className="w-16 h-16 text-red-500" />
                <p className="text-center text-gray-800 text-lg font-medium">Are you sure you want to delete this branch?</p>
