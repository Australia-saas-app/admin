...
import { IUser, IDecodedToken } from "@/src/shared/types/auth.types";
import { getCurrentUser } from "@/src/infra/api/AuthService";

// import { getCurrentUser } from "@/infra/api/AuthService";
