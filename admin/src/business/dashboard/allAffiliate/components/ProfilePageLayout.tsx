...
import { AffiliateDeleteTab } from './AffiliateDeleteTab'
import { AffiliateLogTab } from './AffiliateLogTab'
...
function ProfilePageLayout({
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      {activeTab === "accountDelete" && <AffiliateDeleteTab />}

      {activeTab === "affiliateLog" && <AffiliateLogTab />}
    </div>
  )
}
