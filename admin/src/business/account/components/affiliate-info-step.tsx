...
import { Form, FormField, FormItem, FormControl, FormLabel, FormMessage } from "@/src/shared/ui/form/form"
...
export function AffiliateInfoStep({ onNext, onBack, initialData = {} }: AffiliateInfoStepProps) {
  ...
  return (
    <Card className="w-full shadow-none bg-base-100 md:w-1/2 mx-auto border-2 border-border/50">
