...
export default function TechnicalPaymentLayout() {
      ...
      <Card className="shadow-none bg-transparent border-0">
        <CardHeader className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <TabButton label="Payment" isActive onClick={() => {}} />
          </div>
          <SearchInput value={search} onChange={(v) => setSearch(v)} placeholder="Search transactions..." />
        </CardHeader>
              ...
              <Table>
                ...
                <TableBody>
                  {pageData.length === 0 ? (
                    <TableRow>
                      <TableColumn>
                        <span className="block py-10 text-center text-sm text-gray-500">
